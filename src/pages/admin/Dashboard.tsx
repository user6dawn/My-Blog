      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="space-x-4">
            <Link to="/admin/ads" className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
              Manage Ads
            </Link>
            <button
...
<div className="bg-white rounded-lg shadow-md p-6 my-8">
  ...
  {galleryError && <p className="text-red-600 mb-2">{galleryError}</p>}
  <form onSubmit={handleGallerySubmit} className="space-y-4">
    ...
    <button
      ...
      className="w-full bg-blue-600 text-white py-2 px-4 rounded hover:bg-green-700 disabled:opacity-50"
    >
